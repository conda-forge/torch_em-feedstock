...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/torch_em-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/torch_em-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `torch_em` available on your platform:
...
```
pixi search torch_em --channel conda-forge
```
