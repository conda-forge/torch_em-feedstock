...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/torch_em-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14939&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torch_em-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `torch_em` can be installed with:

```
conda install torch_em
```

It is possible to list all of the versions of `torch_em` available on your platform with:
